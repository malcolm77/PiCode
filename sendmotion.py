...
send_email_attachment('malcolmchalmers@hotmail.com','Motion Alert','Motion Detected\nhttp://bigdadda06.dynu.net:8081',args.filename)
...
uploadtodropbox (args.filename,'/Motion/'+basename(args.filename))
